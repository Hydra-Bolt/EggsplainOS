...

{
  ...
  fileSystems."/" =
    { device = "/dev/disk/by-uuid/1cb732d9-e162-4bd9-accc-816491584bbb";
      fsType = "ext4";
    };

  fileSystems."/boot" =
    { device = "/dev/disk/by-uuid/0E40-A879";
      fsType = "vfat";
  ...
  # networking.interfaces.enp200s0f4u1u4.useDHCP = lib.mkDefault true;
